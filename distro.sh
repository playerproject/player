...
/bin/tar hcvzf $DISTRO.tgz $DISTRO --exclude "*.tgz" --exclude "*CVS" --exclude "\.#*" --exclude "*distro.sh" --exclude "*copyright_header" --exclude "*python*" --exclude "*player-manual*" --exclude "*/client_libs/*/doc" --exclude "*oldc++*" --exclude "*/client_libs/libplayerc/examples" --exclude "*/client_libs/java"
