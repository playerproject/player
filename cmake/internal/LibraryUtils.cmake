...
MACRO (PLAYER_ADD_LIBRARY _name)
    ...
    INSTALL (TARGETS ${_name} RUNTIME DESTINATION ${PLAYER_BINARY_INSTALL_DIR}/
...
MACRO (PLAYER_ADD_EXECUTABLE _name)
    ...
    SET_TARGET_PROPERTIES (${_name} PROPERTIES
                            INSTALL_RPATH "${INSTALL_RPATH};${CMAKE_INSTALL_PREFIX}/${PLAYER_LIBRARY_INSTALL_DIR}"
                            BUILD_WITH_INSTALL_RPATH TRUE)
    INSTALL (TARGETS ${_name} RUNTIME DESTINATION ${PLAYER_BINARY_INSTALL_DIR} COMPONENT applications)
