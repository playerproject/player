...
/**************************************************************************
			        *** GET BYTES  ***
**************************************************************************/
/* Description: This function reads a specified number of bytes from the serial port
...
/* Description: This function gets the position of the specified servo.
   Parameters:  fd: serial port handler, servo_num: the servo number whose size is required
...
/**************************************************************************
		        *** TRACK BLOB  ***
**************************************************************************/
/* Description: This functions starts to Track a Color. It takes in the minimum and 
...
/* Description: The function enables/disables automatic servoing
   Parameters:  fd: serial port handler, on: determines whethere to enable(on=1) or disable(on=0)
...
/**************************************************************************
		        *** STOP TRACKING  ***
**************************************************************************/
/* Description: The function stops the camera from tracking blobs and sending data
   Parameters:  fd: serial port handler
   Returns:     none
*/
...
/**************************************************************************
		        *** READ T PACKET  ***
**************************************************************************/
/* Description: The function reads a t-packet from camera, ex. when camera is tracking
...
{ 
  char packet_type;
  sscanf(tpack_chars, "%c %d %d %d %d %d %d %d %d", &packet_type, &tpacket->middle_x, &tpacket->middle_y,
