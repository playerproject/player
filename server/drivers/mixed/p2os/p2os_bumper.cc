...
Driver* P2OSBumper_Init( ConfigFile* cf, int section)
{
  ...
  {
    PLAYER_ERROR1("driver \"p2os_bumper\" does not support interface \"%s\"\n",
                  interface);
    return(NULL);
  }
  else
    return((Driver*)(new P2OSBumper( cf, section)));
}

// a driver registration function
void 
P2OSBumper_Register(DriverTable* table)
{
...
{
  Lock();
  *((player_bumper_data_t*)dest) = ((player_p2os_data_t*)device_data)->bumper;
