...
system.  This driver is useful for running software (e.g., playernav,
the wavefront driver) that needs a @ref player_interface_localize
device without incurring the computational cost of actually running a
