...
extern "C" {
  ...
  /* provides the following functions to pack and unpack Player's
     message structures using native types and SI units: */
  
  void PlayerSonarData( player_sonar_data_t* player, 
			double* ranges, size_t len );
