...
{
  // Minimal constructor
public: CPositionModel( char* name, char* type,
...
public: static CPositionModel* Creator( char* name, char* type, 
					char* color, CEntity *parent )
  { return( new CPositionModel( name, type, color, parent ) ); }
...
private: int Property( int con, stage_prop_id_t property, 
  ...
  protected: virtual int RtkStartup(rtk_canvas_t* canvas);
#endif
