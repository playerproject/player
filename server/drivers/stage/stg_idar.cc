...
// constructor 
CIdarModel::CIdarModel( char* name, char* type, 
  ...
  : CEntity( name, type, color, parent )
{
  ...
  if( m_parent_entity && m_parent_entity != (CEntity*)CEntity::root )
    {
...
int CIdarModel::RtkStartup(rtk_canvas_t* canvas)
{
