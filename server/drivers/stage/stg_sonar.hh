...
{
  // Default constructor
  public: CSonarModel( char* name, char* type, char* color, CEntity *parent);
  
  // a static named constructor - a pointer to this function is given
  // to the Library object and paired with a string.  When the string
  // is seen in the worldfile, this function is called to create an
  // instance of this entity
public: static CSonarModel* Creator( char* name, char* type, 
				     char* color, CEntity *parent )
  {
    return( new CSonarModel( name, type, color, parent ) );
  }
...
public: 
  ...
  public: virtual int RtkStartup(rtk_canvas_t* canvas);
