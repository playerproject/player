...
./cb_client -i 10  > /dev/null &
./cb_client -i 11  > /dev/null &
./cb_client -i 12  > /dev/null &
./cb_client -i 13  > /dev/null &
./cb_client -i 14  > /dev/null &
./cb_client -i 15  > /dev/null &
